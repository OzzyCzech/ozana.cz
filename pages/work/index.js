...
const CmdDialog = () =>
  <article className="text-center bg-gray-800 p-6 md:p-24 lg:p-32 text-blue-50">
    <h2 className="text-5xl lg:text-6xl xl:text-8xl font-mono font-semibold mb-4">
      <a href="https://github.com/OzzyCzech/cmd-dialog/" target="_blank" className="text-inherit hover:text-blue-100 hover:no-underline">cmd-dialog</a>
    </h2>
    <p className="my-2 text-2xl">
      Command dialog and keyboard shortcuts palette for web apps
    </p>
    <p className="flex flex-wrap items-center justify-center gap-2 my-6">
    ...
    <p className="mt-12 flex flex-wrap items-center justify-center gap-3">
      <a href="https://cmd-dialog.vercel.app/" target="_blank" className="py-3 px-6 bg-gray-700 hover:bg-gray-600 rounded-full hover:text-current hover:no-underline inline-flex items-center"><ShareIcon/> Demo page</a>
      <a href="https://github.com/OzzyCzech/cmd-dialog/" target="_blank" className="py-3 px-6 bg-gray-700 hover:bg-gray-600 rounded-full hover:text-current hover:no-underline inline-flex items-center"><GitHubIcon/> GitHub</a>
    </p>
  </article>
