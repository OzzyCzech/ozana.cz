...
export default () =>
  <>
    ...
    <main className="lg:container lg:mx-auto self-center align-center" itemScope itemType="https://schema.org/Person">
      ...
      <div className="text-center mb-10">
        ...
        <p itemProp="address" itemScope itemType="https://schema.org/PostalAddress" className="my-3">
        ...
        <a
          href="/api/ozana"
          className="py-3 px-6 bg-blue-600 hover:bg-blue-700 rounded-full text-white hover:text-white hover:no-underline inline-flex items-center mt-5 ml-2"
          download="Roman Ožana.vcf">
          <DownloadIcon/>
